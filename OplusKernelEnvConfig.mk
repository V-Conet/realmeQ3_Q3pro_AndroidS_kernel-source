...
$(shell ln -sf $(inner_mk_dir)/vendor/oplus/kernel/$(inner_wakelock_dir) $(inner_mk_dir)/drivers/soc/oplus/owakelock)
$(shell ln -sf $(inner_mk_dir)/vendor/oplus/kernel/$(inner_wakelock_dir)/oplus_wakelock_profiler.h $(inner_mk_dir)/include/soc/oplus/oplus_wakelock_profiler.h)
else
